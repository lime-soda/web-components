...
- 29f9f1f: Fix cell ranges doing nothing from the keyboard when the keyboard module is
  installed.
...
- 526f0d8: Add `@lime-soda/grid/range`: selecting a rectangle of cells.
...
- 7051125: `EditModule.setOptions`, so editing can be reconfigured after registration.
...
- 651ffff: Add `@lime-soda/grid/edit`: editing a cell in place.
