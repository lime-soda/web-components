...
describe('FocusController', () => {
  ...
  describe('rows', () => {
    ...
    it('continues into the next instance past the last row', () => {
      ...
      const { focus } = setup();
      focus.focus({ instanceId: 'instance-0', rowKey: 'r9', colId: 'a' });

      expect(focus.moveRow(1)).toBe(true);
      expect(at(focus)).toBe('instance-1/r10/a');
    });

    it('continues back into the previous instance above the first row', () => {
      const { focus } = setup();
      focus.focus({ instanceId: 'instance-1', rowKey: 'r10', colId: 'a' });
    ...
    it('stops at the very end', () => {
      const { focus } = setup();
      focus.focus({ instanceId: 'instance-2', rowKey: 'r24', colId: 'a' });
  ...
  describe('columns', () => {
    ...
    it('carries into the next instance past the last column', () => {
      const { focus } = setup();
      focus.focus({ instanceId: 'instance-0', rowKey: 'r3', colId: 'c' });
    ...
    it('carries back into the previous instance before the first column', () => {
      const { focus } = setup();
      focus.focus({ instanceId: 'instance-1', rowKey: 'r13', colId: 'a' });
    ...
    it('clamps the row when the neighbouring instance is shorter', () => {
      ...
      const { focus } = setup();
      focus.focus({ instanceId: 'instance-1', rowKey: 'r19', colId: 'c' });
  ...
  describe('instances', () => {
    it('jumps forward keeping row and column', () => {
      const { focus } = setup();
      focus.focus({ instanceId: 'instance-0', rowKey: 'r2', colId: 'b' });
    ...
    it('stops at the last instance', () => {
      const { focus } = setup();
      focus.focus({ instanceId: 'instance-2', rowKey: 'r20', colId: 'a' });
    ...
    it('clamps into a shorter instance', () => {
      const { focus } = setup();
      focus.focus({ instanceId: 'instance-1', rowKey: 'r19', colId: 'a' });
  ...
  describe('edges', () => {
    it('moves to the start and end of a row', () => {
      const { focus } = setup();
      focus.focus({ instanceId: 'instance-1', rowKey: 'r12', colId: 'b' });
  ...
  describe('staleness', () => {
    it('refuses to move from a position that no longer exists', () => {
      ...
      const { focus } = setup();
      focus.focus({ instanceId: 'instance-9', rowKey: 'gone', colId: 'a' });
